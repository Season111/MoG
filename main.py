...
if __name__ == '__main__':
    ...
    parser.add_argument("--infer_method", type=str, default="joint", choices=["joint", "multi"])
        ...
        # joint for Mowst-*
        # multi for Mowst
    parser.add_argument('--model1', type=str, default='MLP', choices=["MLP", "GCN", "Sage", "GKAN"],
    ...
    parser.add_argument('--model2', type=str, default='GCN', choices=["MLP", "GCN", "GAT", "GIN", "GKAN", "Sage"], 
